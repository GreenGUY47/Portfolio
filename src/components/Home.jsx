...
const Home = () => {
  ...
  const stats = [
    { value: t('home.stats.experience.value'), label: t('home.stats.experience.label') },
  ...
  return (
    <section className="relative w-full min-h-screen bg-orange-500 text-white overflow-x-hidden font-sans selection:bg-white/30 dark:bg-slate-900 dark:bg-gradient-to-br dark:from-slate-900 dark:to-slate-800">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-16 -left-16 w-64 h-64 xl:w-96 xl:h-96 2xl:w-[480px] 2xl:h-[480px] rounded-full bg-amber-400/30 dark:bg-slate-800/50"
      ...
      <div className="relative z-10 max-w-screen-xl 2xl:max-w-screen-2xl mx-auto px-5 sm:px-8 lg:px-14 lg:-left-2 xl:px-20 2xl:px-28 py-10 xl:py-16 xl:-left-15 2xl:py-20">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-10 xl:mb-14 2xl:mb-18">
          <h2 className="flex items-center cursor-default gap-2 text-xl sm:text-2xl xl:text-3xl 2xl:text-4xl text-white font-bold dark:text-white/90">
            {t('home.greeting')}
            <span onMouseEnter={handleHover} onMouseDown={handleHover} className="cursor-pointer select-none">
              <Player ref={playerRef} icon={hand} trigger="click" size={36} onComplete={() => setIsPlaying(false)} />
            </span>
          </h2>
          ...
          <div className="flex-1 w-full order-2 lg:order-1">
            ...
            <div className="mb-6 xl:mb-8 2xl:mb-10 relative">
              <div className="relative">
                ...
                <h2 className="font-black cursor-default leading-[0.9] tracking-tighter select-none absolute top-0 left-0 pointer-events-none"
                  style={{ fontSize: "clamp(3.5rem, 10vw, 9rem)", WebkitTextStroke: "2px rgba(255,255,255,0.15)", color: "transparent", transform: "translate(4px, 4px)" }}>
                  {t('home.headline1')}
                </h2>
              </div>
              <p className="font-black italic text-right text-white/30 cursor-default leading-none tracking-tighter mt-1"
            ...
            <div className="flex flex-wrap gap-3 xl:gap-4 mb-10 xl:mb-12 2xl:mb-16">
              <a href="#projects"
                ...
                {t('home.cta.viewWork')}
                <svg className="w-4 h-4 xl:w-5 xl:h-5 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="order-1 lg:order-2 flex-shrink-0 w-full max-w-[280px] sm:max-w-[340px] lg:max-w-[380px] xl:max-w-[440px] 2xl:max-w-[560px] mx-auto lg:mx-0">
            <div className="relative">
              ...
              <div className="relative aspect-[4/5] rounded-[2rem] xl:rounded-[2.5rem] 2xl:rounded-[3rem] overflow-hidden shadow-2xl bg-slate-700">
                <img src={ownerImg} alt="Azam — Full Stack Developer" className="w-full h-full object-cover object-top" style={{ filter: "brightness(0.95)" }} />
