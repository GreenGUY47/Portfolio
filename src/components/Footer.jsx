...
const socials = [
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 xl:w-6 xl:h-6">
  ...
  },
  {
    ...
    icon: (
      <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8} className="w-5 h-5 xl:w-6 xl:h-6">
...
const stack = ["React", "Node.js", "MongoDB", "Tailwind", "Express", "TypeScript"];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 xl:gap-10 2xl:gap-14 py-10 xl:py-14 2xl:py-16 border-b border-white/15">
          ...
          <div className="sm:col-span-2 lg:col-span-1 flex flex-col gap-4 xl:gap-5">
            ...
            <p className="text-white/65 text-sm xl:text-base 2xl:text-lg leading-relaxed max-w-xs">
              Full Stack Developer & Designer crafting fast, scalable, and visually refined web experiences.
            </p>
            {/* Social icons */}
          ...
          <div className="flex flex-col gap-3 xl:gap-4">
            ...
            >
              <span className="text-white/40 text-[10px] xl:text-xs uppercase tracking-widest">Email</span>
            ...
            <a
              ...
              className="group flex flex-col gap-0.5 text-white/70 hover:text-white transition-colors duration-150"
            >
              <span className="text-white/40 text-[10px] xl:text-xs uppercase tracking-widest">WhatsApp</span>
              <span className="text-sm xl:text-base font-medium">+92 312 412 3581</span>
            </a>
            <div className="flex flex-col gap-0.5">
              <span className="text-white/40 text-[10px] xl:text-xs uppercase tracking-widest">Location</span>
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <span className="text-white/60 text-xs xl:text-sm font-medium">Open to opportunities</span>
            </div>
          </div>
