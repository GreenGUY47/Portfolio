  ...
  },
  {
    ...
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
        className="w-5 h-5 xl:w-6 xl:h-6 text-blue-300"
      >
  ...
  },
  {
    ...
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
        className="w-5 h-5 xl:w-6 xl:h-6 text-pink-300"
      >
...
const Contact = () => {
  ...
  const socials = t("contact.social.items", { returnObjects: true }).map(
    (s, i) => ({
      ...s,
      ...socialIcons[i],
    }),
            ...
            <div className="flex flex-col gap-2 xl:gap-3">
              ...
              >
                <div className="shrink-0 w-11 h-11 xl:w-13 xl:h-13 2xl:w-15 2xl:h-15 rounded-xl xl:rounded-2xl bg-orange-300/20 border border-orange-300/25 flex items-center justify-center">
                  <svg
                    className="w-5 h-5 xl:w-6 xl:h-6 text-orange-200"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth={1.5}
                ...
                <svg
                  className="w-5 h-5 xl:w-6 xl:h-6 text-white/30 group-hover:text-white/80 group-hover:translate-x-1 transition-all duration-200 shrink-0"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={2}
              ...
              >
                <div className="shrink-0 w-11 h-11 xl:w-13 xl:h-13 2xl:w-15 2xl:h-15 rounded-xl xl:rounded-2xl bg-green-400/15 border border-green-400/25 flex items-center justify-center">
                  <svg
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="w-5 h-5 xl:w-6 xl:h-6 text-green-300"
                  >
              ...
              <div className="grid grid-cols-3 gap-3 xl:gap-4">
                {socials.map((s) => (
                  ...
                  >
                    ...
                    <span className="text-white/35 text-[10px] xl:text-xs">
                      {s.handle}
                    </span>
                  </a>
                ))}
          ...
          <div className="lg:col-span-2 flex flex-col gap-5 xl:gap-6 2xl:gap-7">
              ...
              <div className="flex flex-col gap-4 xl:gap-5">
                {faqs.map((f, i) => (
                  <div
                    ...
                    className={
                      i < faqs.length - 1
                        ? "pb-4 xl:pb-5 border-b border-white/10"
                        : ""
                    }
                  >
            ...
            <div className="bg-black/20 backdrop-blur-md border border-white/15 rounded-2xl xl:rounded-3xl p-5 xl:p-7 2xl:p-9">
              ...
              <div className="flex items-center gap-3 xl:gap-4 mb-4">
                ...
                />
                <div>
                  <p className="text-white font-bold text-sm xl:text-base 2xl:text-lg">
                    {t("contact.location.city")}
                  </p>
                  <p className="text-white/55 text-xs xl:text-sm">
                    {t("contact.location.timezone")}
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-2 px-3 py-2 xl:px-4 xl:py-2.5 rounded-xl bg-white/10 border border-white/10 w-fit">
                ...
                <span className="text-white/70 text-xs xl:text-sm font-medium">
