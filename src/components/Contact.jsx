...
/* ─── FAQ / quick facts ─────────────────────────────────────── */
const faqs = [
  { q: "What's your response time?", a: "Usually within a few hours — I check messages regularly." },
  { q: "Are you available for freelance?", a: "Yes! Open to short and long-term projects, remote worldwide." },
  { q: "Do you work in teams?", a: "Absolutely — I'm comfortable with Agile workflows and async collaboration." },
];
          ...
          <div className="lg:col-span-3 flex flex-col gap-5 xl:gap-6 2xl:gap-7">
            ...
            <div className="bg-black/25 backdrop-blur-md border border-white/15 rounded-2xl xl:rounded-3xl p-5 xl:p-7 2xl:p-9">
              ...
              <p className="text-white/70 text-sm xl:text-base 2xl:text-lg leading-relaxed">
                Whether it's a project, collaboration, a job opportunity, or just saying hello —
                I'd love to hear from you. Pick any channel below and let's start a conversation.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-2 xl:gap-3">
              <div className="flex items-center gap-2">
                ...
                <p className="text-white/60 text-xs xl:text-sm font-semibold uppercase tracking-widest">Email</p>
              </div>
              <a
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-white/55 text-[10px] xl:text-xs uppercase tracking-widest mb-0.5">Write to me</p>
            ...
            <div className="flex flex-col gap-2 xl:gap-3">
              <div className="flex items-center gap-2">
                <div className="w-1 h-4 xl:h-5 bg-white rounded-full" />
                <p className="text-white/60 text-xs xl:text-sm font-semibold uppercase tracking-widest">WhatsApp</p>
              </div>
              <a
              ...
              >
                ...
                <div className="flex-1">
                  <p className="text-white/55 text-[10px] xl:text-xs uppercase tracking-widest mb-0.5">Message me</p>
            ...
            <div className="flex flex-col gap-2 xl:gap-3">
              <div className="flex items-center gap-2">
                <div className="w-1 h-4 xl:h-5 bg-white rounded-full" />
                <p className="text-white/60 text-xs xl:text-sm font-semibold uppercase tracking-widest">Social</p>
              </div>
              <div className="grid grid-cols-3 gap-3 xl:gap-4">
                {socials.map((s) => (
                  ...
                  >
                    {s.icon}
                    <span className="text-white/70 text-xs xl:text-sm font-semibold group-hover:text-white transition-colors">
                      {s.label}
                    </span>
          ...
          <div className="lg:col-span-2 flex flex-col gap-5 xl:gap-6 2xl:gap-7">
              ...
              <div className="flex flex-col gap-4 xl:gap-5">
                {faqs.map((f, i) => (
                  <div key={i} className={i < faqs.length - 1 ? "pb-4 xl:pb-5 border-b border-white/10" : ""}>
                    <p className="text-white font-semibold text-sm xl:text-base 2xl:text-lg mb-1.5">
                      {f.q}
                    </p>
                    <p className="text-white/60 text-xs xl:text-sm 2xl:text-base leading-relaxed">
                      {f.a}
                    </p>
                  </div>
                ))}
            ...
            <div className="bg-black/20 backdrop-blur-md border border-white/15 rounded-2xl xl:rounded-3xl p-5 xl:p-7 2xl:p-9">
              ...
              <div className="flex items-center gap-3 xl:gap-4 mb-4">
                ...
                />
                <div>
                  <p className="text-white font-bold text-sm xl:text-base 2xl:text-lg">Lahore, Pakistan</p>
                  <p className="text-white/55 text-xs xl:text-sm">GMT+5 · PKT</p>
                </div>
              </div>
              <div className="flex items-center gap-2 px-3 py-2 xl:px-4 xl:py-2.5 rounded-xl bg-white/10 border border-white/10 w-fit">
                ...
                <span className="text-white/70 text-xs xl:text-sm font-medium">Available for remote work worldwide</span>
              </div>
              {/* Pakistan Zindabad */}
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl xl:rounded-3xl p-5 xl:p-7 2xl:p-9 flex flex-col gap-4">
              <p className="text-white font-bold text-base xl:text-lg 2xl:text-xl">
                Ready to build something great?
              </p>
              <p className="text-white/65 text-xs xl:text-sm 2xl:text-base leading-relaxed">
                Drop me a message and let's turn your idea into a real, polished product.
              </p>
              <a
                href="mailto:thegreenguy48@gmail.com"
