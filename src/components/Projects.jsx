        ...
        >
          {loading ? (
            ...
            <>
              ...
              >
                <svg className="w-4 h-4 xl:w-5 xl:h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        {!loading && (
          <>
            <button
              ...
              onMouseEnter={stopSlide}
              onMouseLeave={startSlide}
              className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 xl:-translate-x-5 w-9 h-9 xl:w-11 xl:h-11 2xl:w-13 2xl:h-13 rounded-full bg-white shadow-lg flex items-center justify-center hover:scale-110 hover:shadow-xl transition-all duration-200 z-10"
            >
              <svg className="w-4 h-4 xl:w-5 xl:h-5 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
            ...
            <button
              ...
              onMouseEnter={stopSlide}
              onMouseLeave={startSlide}
              className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 xl:translate-x-5 w-9 h-9 xl:w-11 xl:h-11 2xl:w-13 2xl:h-13 rounded-full bg-white shadow-lg flex items-center justify-center hover:scale-110 hover:shadow-xl transition-all duration-200 z-10"
            >
              <svg className="w-4 h-4 xl:w-5 xl:h-5 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
      ...
      {!loading && total > 1 && (
        <div className="flex gap-1.5 xl:gap-2">
          {imagesRef.current.map((_, i) => (
            <button
              key={i}
              onClick={() => { stopSlide(); setIndex(i); setTimeout(startSlide, 100); }}
            ...
            {videoReady ? (
              ...
              <div className="w-full aspect-video rounded-2xl xl:rounded-3xl overflow-hidden relative bg-black/40 border border-white/10">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
                  ...
                  <p className="text-white/50 text-xs xl:text-sm font-medium tracking-wider uppercase">Loading video</p>
                </div>
              </div>
            )}
          </div>
