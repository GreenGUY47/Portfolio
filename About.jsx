...
const AboutMe = () => {
      ...
      <div className="w-full flex flex-col flex-1 overflow-hidden justify-between mt-4 gap-3">
        ...
        <div className="flex flex-col md:flex-row justify-center w-full px-4 gap-4 items-center">
          <div className="bg-gradient-to-br from-[#0f172a] via-[#111827] to-black border-2 border-gray-700 shadow-lg rounded-3xl text-white font-light text-justify leading-6 w-full max-w-3xl p-4 text-sm md:text-base lg:text-lg">
            ...
            passionate about building modern, responsive, and impactful digital
            experiences. I specialize in transforming ideas into powerful web
            applications that are fast, scalable, and visually refined. With
            strong expertise in <span className="text-cyan-400">React</span>,{" "}
            <span className="text-orange-400">HTML5</span>,{" "}
            <span className="text-blue-400">CSS3</span>, and{" "}
            <span className="text-yellow-300">JavaScript</span>, combined with
            backend skills in <span className="text-green-400">Node.js</span>{" "}
            and <span className="text-purple-400">MongoDB</span>, I create
        ...
        <div className="flex justify-center w-full px-4">
          <div className="bg-gradient-to-br from-[#0f172a] via-[#111827] to-black border-2 border-gray-700 shadow-lg rounded-3xl text-white font-light text-justify leading-6 w-full max-w-3xl p-4 text-xs sm:text-sm md:text-base flex flex-col sm:flex-row items-start gap-3">
            <FontAwesomeIcon
              ...
              className="text-orange-300 text-2xl mt-1 shrink-0"
            />
            <p>
              I am constantly evolving as a developer — learning new frameworks,
              sharpening my problem-solving skills, and pushing the boundaries
              of what I can build. My goal is to craft{" "}
              <span className="text-orange-300 font-semibold">
                meaningful digital products
              </span>{" "}
              that leave a lasting impression. Whether working solo or in a
              team, I bring dedication, creativity, and a hunger for excellence
  ...
  <div className="scroller-track text-white">
    {[...icons].map((icon, i) => (
      <span key={i}>
  ...
  <div className="scroller-track-2 text-white">
    {[...icons].map((icon, i) => (
      <span key={i}>
        <FontAwesomeIcon icon={icon} />
      </span>
